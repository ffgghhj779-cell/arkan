...
const slides = [
  {
    ...
    accent: "يا تحبها",
    image:
      "https://images.unsplash.com/photo-1543339308-43e59d6b73a6?q=80&w=1600&auto=format&fit=crop",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Animated concentric arcs — refined stage effect */}
        <motion.div
          animate={{ rotate: 360 }}
          transition={{ duration: 120, repeat: Infinity, ease: "linear" }}
          className="absolute left-1/2 -translate-x-1/2 bottom-[-55%] w-[160vmax] h-[160vmax] rounded-full border-[3px] border-arkan-orange/20"
        />
        <div className="absolute left-1/2 -translate-x-1/2 bottom-[-48%] w-[130vmax] h-[130vmax] rounded-full border-[2px] border-white/5" />
        <div className="absolute left-1/2 -translate-x-1/2 bottom-[-42%] w-[105vmax] h-[105vmax] rounded-full bg-gradient-to-t from-arkan-orange/30 via-arkan-orange/10 to-transparent blur-3xl" />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full py-28 md:py-32">
        <AnimatePresence mode="wait" custom={direction}>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="my-4 md:my-6 w-36 h-24 md:w-40 md:h-28 bg-arkan-orange text-white rounded-[38%] flex flex-col items-center justify-center font-black text-2xl shadow-glass border-[3px] border-white/90 -rotate-2 hover:rotate-0 transition-transform cursor-pointer leading-none pt-1 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/40"
              aria-label="عن أركان"
            >
        ...
        >
          <motion.button
            ...
            className="px-8 py-3.5 bg-white text-arkan-orange font-black text-base md:text-lg rounded-full shadow-premium hover:shadow-premium-hover transition-shadow focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/50"
          >
            اكتشف منتجاتنا
          </motion.button>
          <motion.button
            ...
            className="px-8 py-3.5 bg-white/10 backdrop-blur-md text-white font-bold text-base md:text-lg rounded-full border border-white/25 hover:bg-white/20 transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/30"
          >
            فوائد التجميد
          </motion.button>
        </motion.div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={prev}
        className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 w-11 h-11 md:w-12 md:h-12 bg-white/15 backdrop-blur-md rounded-full flex items-center justify-center z-30 border border-white/20 shadow-glass transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/40"
      >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={next}
        className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 w-11 h-11 md:w-12 md:h-12 bg-white/15 backdrop-blur-md rounded-full flex items-center justify-center z-30 border border-white/20 shadow-glass transition-colors focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-white/40"
      >
      ...
      <motion.button
        ...
        className="absolute bottom-8 md:bottom-12 right-6 md:right-10 z-30 p-2 text-white/60 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded-full"
      >
