          ...
          <div className="flex flex-col gap-2 items-end z-50">
            <div className="flex items-center gap-4 text-sm font-bold opacity-90">
              <div className="flex items-center gap-3">
                <motion.a whileHover={{ scale: 1.2, rotate: 5 }} href="#" className="hover:text-white transition-all"><Facebook className="w-4 h-4" /></motion.a>
                <motion.a whileHover={{ scale: 1.2, rotate: 5 }} href="#" className="hover:text-white transition-all"><Instagram className="w-4 h-4" /></motion.a>
                <motion.a whileHover={{ scale: 1.2, rotate: 5 }} href="#" className="hover:text-white transition-all"><Twitter className="w-4 h-4" /></motion.a>
                <motion.a whileHover={{ scale: 1.2, rotate: 5 }} href="#" className="hover:text-white transition-all"><Youtube className="w-4 h-4" /></motion.a>
              </div>
              <div className="w-px h-4 bg-white/30 mx-2" />
              <button className="hover:text-white/70 transition-colors">EN</button>
              <span>|</span>
              <button className="text-white hover:text-white/70 transition-colors relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-white">العربية</button>
            </div>
